...
api.add_route("/api/league/", league_list)
api.add_route("/api/league/{league_id}/", league)
api.add_route("/api/league/{league_id}/tournaments/", tournament_list)
api.add_route("/api/league/{league_id}/tournaments/{tournament_id}", tournament)
api.add_route("/api/league/{league_id}/tournaments/{tournament_id}/brackets/", bracket_list)
api.add_route("/api/league/{league_id}/tournaments/{tournament_id}/brackets/{bracket_id}", bracket)
api.add_route("/api/league/{league_id}/tournaments/{tournament_id}/brackets/{bracket_id}/matches/", match_list)
api.add_route("/api/league/{league_id}/tournaments/{tournament_id}/brackets/{bracket_id}/matches/{match_id}", match)
api.add_route("/api/league/{league_id}/tournaments/{tournament_id}/brackets/{bracket_id}/matches/{match_id}/games/", game_list)
