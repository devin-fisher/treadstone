define('app',['exports', './match', './league', './bracket', './tournament', './match-report-dialog', 'aurelia-http-client', 'aurelia-dialog', 'aurelia-framework', 'bootstrap'], function (exports, _match, _league, _bracket, _tournament, _matchReportDialog, _aureliaHttpClient, _aureliaDialog, _aureliaFramework, _bootstrap) {
  'use strict';
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_aureliaDialog.DialogService), _dec(_class = function () {
    function App(dialogService, httpClient) {
    ...
    App.prototype.openMatchReportDialog = function openMatchReportDialog(match) {
      ...
      this.httpClient.createRequest(url).asGet().send().then(function (data) {
        var games = JSON.parse(data.response);
        dservice.open({ viewModel: _matchReportDialog.MatchReportPrompt, model: { "match": match, "games": games } }).then(function (response) {
    ...
    App.prototype._populate = function _populate(obj, objList, clearArrays, url, subObjList, createSubObj) {
      if (obj && obj.selected) {
        return;
      }
    ...
    App.prototype.populateLeague = function populateLeague() {
      this._populate(null, null, [this.leagues, this.tournaments, this.brackets, this.matches], 'api/leagues', this.leagues, function (entry) {
        return new _league.League(entry);
      });
    };

    App.prototype.populateTournaments = function populateTournaments(league) {
      this._populate(league, this.leagues, [this.tournaments, this.brackets, this.matches], 'api/leagues/' + league.id + '/tournaments/', this.tournaments, function (entry) {
        return new _tournament.Tournament(entry);
      });
    };

    App.prototype.populateBrackets = function populateBrackets(tournament) {
      this._populate(tournament, this.tournaments, [this.brackets, this.matches], 'api/leagues/' + tournament.league_id + '/tournaments/' + tournament.id + '/brackets', this.brackets, function (entry) {
        return new _bracket.Bracket(entry);
      });
    };

    App.prototype.populateMatches = function populateMatches(bracket) {
      this._populate(bracket, this.brackets, [this.matches], 'api/leagues/' + bracket.league_id + '/tournaments/' + bracket.tournament_id + '/brackets/' + bracket.id + '/matches', this.matches, function (entry) {
        return new _match.Match(entry);
      });
    };

    App.prototype.select = function select(set, value) {
...
define('bracket',["exports"], function (exports) {
  "use strict";
  ...
  var Bracket = exports.Bracket = function () {
    function Bracket(modelVal) {
...
define('league',["exports"], function (exports) {
  "use strict";
  ...
  var League = exports.League = function () {
    function League(modelVal) {
...
define('match',["exports"], function (exports) {
  "use strict";
...
define('tournament',["exports"], function (exports) {
  "use strict";
...
define('video-dialog',['exports', 'aurelia-dialog', 'aurelia-framework', 'aurelia-http-client'], function (exports, _aureliaDialog, _aureliaFramework, _aureliaHttpClient) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.MatchReportPrompt = undefined;
  ...
  var MatchReportPrompt = exports.MatchReportPrompt = (_dec = (0, _aureliaFramework.inject)(_aureliaDialog.DialogController), _dec(_class = function () {
    function MatchReportPrompt(controller) {
      _classCallCheck(this, MatchReportPrompt);
    ...
    MatchReportPrompt.prototype.activate = function activate(args) {};

    _createClass(MatchReportPrompt, [{
      key: 'youtube_video_url',
      get: function get() {
        return 'https://www.youtube.com/embed/geGlkI9lVpk?wmode=transparent';
      }
    }]);

    return MatchReportPrompt;
  }()) || _class);
});
...
define('match-report-dialog',['exports', 'aurelia-dialog', 'aurelia-framework', 'aurelia-http-client'], function (exports, _aureliaDialog, _aureliaFramework, _aureliaHttpClient) {
  'use strict';
