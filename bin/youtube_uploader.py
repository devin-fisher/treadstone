...
def roster(team):
    ...
    for a in range(0,5):
        ...
        if role == "support":
            team2[4] = player
    rosters = []
    rosters.append(team1)
    rosters.append(team2)
...
def description(schedule,team,match):
    ...
    description = line1 + "#n#n" + line2 + "#n" + line3 + "#n#n" + line4 + "#n#n" + roster_info[0] + "#n" + roster_info[1] + "#n" + roster_info[2] + "#n" + roster_info[3] + "#n" + roster_info[4] + "#n#n" + line5 + "#n#n" + roster_info[5] + "#n" + roster_info[6] + "#n" + roster_info[7] + "#n" + roster_info[8] + "#n" + roster_info[9]
...
def client_secrets():
    client_secrets = "C:\youtube_upload\youtube-upload-master\client_secrets.json"
...
def upload(schedule,team,match):
    title = title_info(schedule,team,match)
